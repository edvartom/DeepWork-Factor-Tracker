...
This programming project is made in order to plot factors related to Tom's deep work sessions against each other. This spesific task is done in the **'main.jl'**-file. The file 'change-data.jl' can be used for making new random data related to Tom's deep work sessions.
