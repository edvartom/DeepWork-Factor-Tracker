...
This programming project is made in order to plot these factors against each other. You choose which factors are to be on the x- and y-axis. Just **RUN main.jl** and **FOLLOW THE INSTRUCTIONS GIVEN IN THE TERMINAL**

The data is random, so I do not expect you to find any relations.

<br>

---
\*This is a non-fictive book I recommend. Source: Newport, C. (2016).*Deep Work: Rules for Focused Success in a Distracted World.* Grand Central Publishing.